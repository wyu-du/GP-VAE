...
class Seq2SeqModel(T5ForConditionalGeneration):
    ...
    def prior(self, hidden_states, attention_mask):
        representations, _ = self.averageSelfAttention_prior(hidden_states, attention_mask)
    ...
    def forward(
        ...
        # added z code here
        prior_mean, prior_logvar = self.prior(hidden_states, attention_mask)
...
if __name__ == '__main__':
    ...
    p.add_argument('-time', '--timestamp', type=str, default='2021-02-14-04-57-04', 
                   help="Model checkpoint")
    p.add_argument('-f', '--flag', type=str, default='cvae', 
                   help="Model checkpoint")
